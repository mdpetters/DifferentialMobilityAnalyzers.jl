...
function β12brown(Dp_i, Dp_j; ρi = 1000.0, ρj = 1000.0, p = 1e5, T = 293.0)
    # +
...
function β12zebel(Dp_i, Dp_j, q_i, q_j; ρi = 1000.0, ρj = 1000.0, p = 1e5, T = 293.0)
    # +
...
function β12(Dp_i, Dp_j, q_i, q_j; ρi = 1000.0, ρj = 1000.0, p = 1e5, T = 293.0)
