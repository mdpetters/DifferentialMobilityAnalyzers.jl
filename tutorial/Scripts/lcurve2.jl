function getpsd2()
    ...
    setupRegularization(δ.𝐀, eyeM, 𝕣.N, [0.0 for i in 𝕣.N], 1)
    𝕟, 𝕣
end
...
function lcurvefig2()
    ...
    L1, L2, λs, ii = lcurve(0.01, 1.0; n = 50)
    mL1, mL2 = reginv([0.01, 0.05, 0.1, λopt, 0.5, 1.0]; r = :L1L2)
    ...
    p2 = plot(
        ...
        Guide.title("Tikhonov: 𝕟ⁱⁿᵛ=(𝐀ᵀ𝐀+λ²𝐈)⁻¹𝐀ᵀ𝕣"),
        Guide.xticks(
